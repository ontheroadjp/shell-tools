...
alias cfile='(){_find_count ${1:-.} f}'
alias cdir='(){_find_count ${1:-.} d}'
alias cimg='(){_find_count ${1:-.} f "(JPG|jpg|jpeg|PNG|png|TIFF|TIF|tiff|tif|CR2|NEF|ARW)"}'
alias cmovie='(){_find_count ${1:-.} f "(MOV|mov|AVI|avi|MPG|mpg|mpeg|mp4)"}'
alias cmusic='(){_find_count ${1:-.} f "(m4a|MP3|mp3|WAV|wav)"}'
